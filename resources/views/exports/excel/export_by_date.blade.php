...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="no-border" colspan="8">: {{ Carbon\Carbon::parse($start_date)->translatedFormat('d F Y') }} -
                {{ Carbon\Carbon::parse($end_date)->translatedFormat('d F Y') }}</td>
        </tr>
        <tr>
            <td class="no-border" colspan="2"><strong>Tanggal Jam Download</strong></td>
            <td class="no-border" colspan="8">: {{ $download_time }}</td>
        </tr>
    </table>
        ...
        <thead>
            <tr>
                ...
                <th style="width: 125px; text-align:center; word-wrap: break-word; border: 1px solid black;">Dokumentasi
                    Humas</th>
                <th style="width: 125px; text-align:center; word-wrap: break-word; border: 1px solid black;">PIC</th>
        ...
        <tbody>
            @foreach ($sendvicon as $vicon)
                <tr>
                    ...
                    <td style="word-wrap: break-word; border: 1px solid black;">Sabtu, 26 Oktober 2024</td>
                    ...
                    <td style="word-wrap: break-word; border: 1px solid black;">{{ $vicon->bagian->bagian }}
                    </td>
