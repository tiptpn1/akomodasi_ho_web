                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel">Tambah Permintaan Makan Siang</h4>
                                ...
                                <div id="kaskecil" class="form-group container-fluid">
                                    <form id="form_tambah" class="form-horizontal calender" role="form" enctype="multipart/form-data" method="POST" action="/makansiang/store">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <b>Jumlah Makan Siang <span class="text-danger">*</span></b>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                @php
                                                    ...
                                                    $isDisabled = $requestDate->lte($today) || $item->status == 0; // Disabled jika tgl_permintaan <= hari ini atau status = 0
                                                ...
                                                <!-- Delete Button -->
                                                <form action="{{ route('makansiang.destroy', $item->id ?? '-') }}" method="POST" onsubmit="return confirm('Apakah yakin menghapus data ini?')">
                                                    @csrf
                                                    @method('DELETE')
            ...
            $(document).on('click', '.btn-info', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('input[name="tgl_pengajuan1"]').val(data.tgl_permintaan);
