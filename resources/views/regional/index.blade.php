    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h3 class="mt-4">Master Regional</h3>
                @if (!in_array(Auth::user()->master_hak_akses_id, [5, 6]))
                    ...
                    <a href="{{ route('masterregional.export') }}" class="btn btn-warning btn-sm">Export to Excel</a>
                @endif
                @if (session('success'))
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel">Tambah Regional</h4>
                            ...
                            <div class="modal-body">
                                <div id="kaskecil" class="form-group container-fluid">
                                    <form id="form_tambah" class="form-horizontal calender" role="form"
                                        enctype="multipart/form-data" method="POST" action="/masterregional/store">
                                        @csrf
                                        <div class="row">
                                            <div class="form-group col-md-12">
                                                <b>Nama Regional <span class="text-danger">*</span></b>
                                ...
                                <div id="kaskeciledit" class="form-group container-fluid">
                                    <form id="form_edit" class="form-horizontal calender" role="form"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                <b>Nama Regional <span class="text-danger">*</span></b>
                                                <input type="text" class="form-control" name="nama_regional1"
                                                    id='nama_regional1' required>
                                            </div>
                                        </div>
                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="dataTables-kaskecil">
                                ...
                                <tbody>
                                    @foreach ($regionals as $index => $regionals)
                                        <tr align="center">
                                            <td>{{ $index + 1 }}</td>
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <!-- Delete Button -->
                                                    <form
                                                        action="{{ route('masterregional.destroy', $regionals->id_regional) }}"
                                                        method="POST"
    ...
    <x-slot name="scripts">
        ...
        <script>
            $(document).on('click', '.btn-info', function() {
                ...
                $.ajax({
                    url: `/masterregional/edit/${id}`, // Endpoint untuk mendapatkan data
                    method: 'GET',
                    success: function(data) {

                        // Isi modal dengan data dari server
                        $('input[name="id"]').val(data.id_regional);
                        $('input[name="nama_regional1"]').val(data.nama_regional);
        ...
        <script>
            $('#form_edit').on('submit', function(e) {
                ...
                $.ajax({
                    url: `/masterregional/update/${id}`, // Endpoint untuk update
                    method: 'PUT',
                    data: formData,
        ...
        <script>
            $(document).on("click", ".btnDelete", function() {
                ...
                var url = "/masterregional/destroy/" + id; // Sesuaikan dengan route yang dibuat
